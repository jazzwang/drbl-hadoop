...
lb config -b iso -f minimal --cache enabled --cache-indices enabled -d precise --hostname hadoop -m http://free.nchc.org.tw/ubuntu --username hadoop --packages 'net-tools ssh sudo dhcp3-client' -k 686 
